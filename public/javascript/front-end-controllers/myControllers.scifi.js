...
function myRouter($routeProvider) {
    $routeProvider
        .when("/level1", {
            templateUrl: "./html/templates/scifi/scifi.level1.html"
        })
        .when("/level2", {
            templateUrl: "./html/templates/scifi/scifi.level2.html"
        })
        .when("/level3", {
            templateUrl: "./html/templates/scifi/scifi.level3.html"
        })
        .when("/level4", {
            templateUrl: "./html/templates/scifi/scifi.level4.html"
        })
